      ...
      <div className="col-span-9 grid grid-cols-12 gap-6">
        ...
        <div className="col-span-4 bg-[#5f5f5f7b] backdrop-blur-md shadow-sm rounded-lg p-6">
          ...
          <table className="w-full text-left text-white">
            <tbody>
              <tr>
                <td className="py-2 font-medium text-white">Total Revenue:</td>
                <td className="py-2 text-white">$170,000</td>
              </tr>
              <tr className="border-b">
                <td className="py-2 font-medium text-white">Total Expense:</td>
        ...
        <div className="col-span-4 bg-[#5f5f5f7b] backdrop-blur-md shadow-sm rounded-lg p-6">
          ...
          <table className="w-full text-left text-white">
            <tbody>
              <tr>
                <td className="py-2 font-medium text-white">Total Deposit:</td>
                <td className="py-2 text-white">$150,000</td>
              </tr>
              <tr>
                <td className="py-2 font-medium text-white">Total Withdraw:</td>
